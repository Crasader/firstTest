package starling.utils
{
    ...
    public class AssetManager
    {
        private const SUPPORTED_EXTENSIONS:Vector.<String> = 
            new <String>["png", "jpg", "jpeg", "atf", "mp3", "xml", "fnt", "scml"]; 
		 ...
		 * 获取spriter scml文件
		 */
		public function getScml(name:String):XML
		{
			return mScmls[name];
		}
            ...
            function onUrlLoaderComplete(event:Event):void
            {
                ...
                switch (extension)
                {
                    ...
                    case "mp3":
                        ...
                        break;
					case "scml":
						var scmlName:String = url.split("/").pop().split(".")[0].toString();
						if (scmlName)
							mScmls[scmlName] = new XML(bytes);
						onComplete();
						break;
                    default:
